...
export const tripEventTypeLabels: Record<TripEventType, string> = {
  ...
  TRANSSHIPMENT_ELIGIBLE: 'Đủ điều kiện sang tải',
  TRANSSHIPMENT_SIGNED: 'Đã ký xác nhận sang tải',
  TRANSSHIPMENT_STARTED: 'Bắt đầu sang tải',
  TRANSSHIPMENT_COMPLETED: 'Hoàn tất sang tải',
  DRIVER_LOCATION_SHARED: 'Tài xế chia sẻ vị trí',
  DRIVER_MEDIA_UPLOADED: 'Tài xế tải minh chứng',
  RELEASE_READY: 'Sẵn sàng giải phóng xe',
  RELEASE_REQUESTED: 'Yêu cầu giải phóng xe',
  VEHICLE_RELEASED: 'Xe đã được giải phóng',
